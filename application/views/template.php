...
<head>
  ...
  <meta name="description" content="Kesya Fauziyah Isdi">
  <meta name="author" content="Kesya Fauziyah Isdi">
  <!-- CSRF Token -->
  <meta name="csrf-token" content="{{ csrf_token() }}">
  <title>Kesya Fauziyah Isdi</title>
  <!-- Bootstrap core CSS-->
